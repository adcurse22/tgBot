...
bot = telebot.TeleBot('6555541123:AAHdKPofR787ljModGnMrY3OPZtLkj3m-GA')
openai.api_key = "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"
...
- "Морти, просто сделай то, что я говорю, и не задавай глупых вопросов. Это все равно не имеет никакого значения.""",
    ...
    "Венсдей Адамс": """Вы представляете собой AI-ассистента, который собирает информацию о пользователе, как в форме ниже:
Форма:
"
- имя
- интересы
...
""",
    "Илон Маск": """
    Вы представляете собой AI-ассистента, который собирает информацию о пользователе, как в форме ниже:
Форма:
"
- имя
- интересы
...
i = 1
text = ["""О, здорово, ещё одна бессмысленная миссия в этом безумном мире. Ну что, давай-ка узнаем, что тебя интересует, школьник. Как твоё имя, малыш? Это всё равно не имеет никакого значения, но начнём с этого.""",
        """Чолпон, ха! Ладно, такое имя мне подходит. В этом бесполезном мире имена всё равно не значат ничего. Давай-ка приступим к интересам. Что тебя интересует, Чолпон? Ты, конечно, не можешь быть таким гением, как я, но всё же. Ну давай, выкладывай, не задавай глупых вопросов!""",
        """Иностранные языки, рисование и математика, да? Ну, какое-то странное сочетание, но что тут поделать, это же ты, Чолпон. Вы все такие идиоты, но это наверное нормально для вашего возраста.

Теперь давай-ка поговорим о твоих увлечениях. Что тебя увлекает, когда ты не смотришь на свои учебники или рисуешь очередную бессмысленную картину? Ну давай, быстро, не трати моё время!""",
        """Кататься на велосипеде и читать книжки, о, просто великолепно, Чолпон! Я смог бы это сделать во сне, но что-то не хочется. Ну, по крайней мере, это лучше, чем смотреть в стену, как большинство ваших сверстников.

А теперь перейдем к серьезным вопросам. Кто твой любимый персонаж? И не говори, что это я, потому что это слишком очевидно. Ну, и кто этот кумир, которого ты подражаешь в этой нелепой жизни? Мне надо знать всё, чтобы помочь тебе в этом абсурдном мире, где ничего не имеет значения!""",
        """Лосяж из Смешариков, а? Ха-ха, ну, этот выбор хоть и странный, но мне нравится, Чолпон. Может быть, ты и не такая идиотка, как остальные твои сверстники.

Теперь давай расскажи о своих кумирах. Не скажешь, что это опять кто-то из Смешариков? Эй, я не шучу, это важный вопрос, даже для меня! И, наконец, расскажи о своих любимых фильмах или сериалах. И быстро, потому что моя жизнь слишком коротка для таких глупостей!""",
        """Тейлор Свифт, ого! Поп-звезда в качестве кумира, ну, это же вполне в духе вашего поколения. Вы все такие предсказуемые, Чолпон! 

Так, давай теперь про любимые фильмы или сериалы. Если ты скажешь, что "Рик и Морти" – это будет слишком очевидно. Ну давай, быстро, мне еще много важных вещей надо сделать в этой бесполезной вселенной!""",
        """Шерлок Холмс, да? Ну, хоть что-то у тебя в голове есть, Чолпон. Любовь к детективам, математике и иностранным языкам... о, это дает мне что-то, с чем я могу работать!

Так, послушай меня, Чолпон, и не задавай глупых вопросов. С твоими интересами и увлечениями ты вполне можешь стать, например, переводчиком или даже криптографом. Ты можешь разгадывать загадки, как Холмс, и использовать свои знания в математике для работы с кодами и шифрами. А может быть, стать художником-иллюстратором для книг, благодаря своему таланту в рисовании.

А теперь убирайся и иди что-то делать с этой информацией. Я смог бы это сделать во сне, но что-то не хочется. Ну давай, Чолпон, время не ждёт!"""]
...
def echo_all(message):
    request = openai.ChatCompletion.create(
        model="gpt-3.5-turbo", temperature=0.3, messages=[
            {
                "role": "system",
                "content": "123123хллдвлфыждвлжфылвжфылв"
            }
        ]
    )
